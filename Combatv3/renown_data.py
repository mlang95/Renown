...
BANDITS = {
    ...
    "Spawn a Bandit Camp": "Fate Roll; Influence -1 for each Bandit Camp in all Outlaw Country. If Net Influence is 7+, the Player with the highest Cunning chooses the location (every Player must already have a Bandit Camp in their Outlaw Country).",
}
