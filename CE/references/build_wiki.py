...
:root{--bg:#f7f6f3;--panel:#fff;--ink:#1d1d1d;--mut:#888;--line:#e2e0db;--accent:#5b2e8e;--link:#1F4E8C;--hover:#ece9e3;--chip:#eee4f7;--th:#f1efe9;--rowline:#efeee9;--rowhover:#fcfbff;--linkline:#aac;--shadow:rgba(0,0,0,.12)}
...
.mapframe{width:100%;height:78vh;min-height:520px;border:1px solid var(--line);border-radius:9px;background:var(--panel)}
