...
import ce_paths; ce_paths.install(verbose=False)   # renown_data -> renown_data_d10 (d10 values, not d6)
...
KEYWORD_DEF = {
    "Deadly": "Focused Strike: AP -5; Parry/Recover only on Focused",
    "Cleave": "Focused Strike: roll another Strike",
    "Steady": "Init can't be lowered by Tactics",
    "Unwieldy": "Init can't be raised by Tactics",
    "2H": "no Shield",
    "Unstoppable": "-2 to defender Parry (max 10+)",
    "Destroy Shield": "Focused Strike: target loses Shield",
    "Deflect": "vs ranged: -1 Parry (max 10+), no Riposte",
