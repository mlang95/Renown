...
GLOSSARY = {
    ...
    SHATTER_ARMOR:  f"On a {PIVOTAL} Strike: that strike's AP is set to -5, and the defender may Parry or {RECOVER} only with a {PIVOTAL} roll.",
    ...
    MINUS_1_TBH:    f"A physical barrier that applies a cumulative -1 penalty to the attacker's Strike roll against this defender (to a maximum of {CAP_THR}+).",
    ...
    NEGATE_TEMPERED: f"Ignores Tempered: this weapon's AP can reduce the target's Armour Save past {CAP_THR}+ (to auto-fail).",
...
RETINUES = {
    "Levy":           {"cost": 1000, "to_hit": 5, "endurance": 3, "shaking": 5, "unbreakable": False, "speed": 3, "max_size": ARMY_MAX_RETINUES},
    "Man-at-Arms":    {"cost": 2000, "to_hit": 4, "endurance": 4, "shaking": 4, "unbreakable": False, "speed": 3, "max_size": ARMY_MAX_RETINUES},
    "Sergeant":       {"cost": 2500, "to_hit": 2, "endurance": 3, "shaking": 3, "unbreakable": False, "speed": 3, "max_size": ARMY_MAX_RETINUES},
    "Knight Templar": {"cost": 3000, "to_hit": 3, "endurance": 3, "shaking": 2, "unbreakable": False, "speed": 3, "max_size": ARMY_MAX_RETINUES},
}
...
WEAPONS = {
    ...
    "Flail":          {"ap": -2, "init": -1, "tier": "Wrought", "tags": [UNWIELDY, CLEAVE, UNSTOPPABLE, NEGATE_RIPOSTE], 'note': 'Cannot Dual Wield'},
    "Halberd":        {"ap": -3, "init":  0, "tier": "Wrought", "tags": [TWO_H, UNWIELDY, UNSTOPPABLE]},
    "Battle Axe":     {"ap": -4, "init": -1, "tier": "Wrought", "tags": [TWO_H, UNWIELDY, UNSTOPPABLE, CLEAVE, NEGATE_SHIELDED]},
    "Cavalry Spear":  {"ap": -2, "init":  1, "tier": "Wrought", "tags": [STEADY, UNWIELDY, NEGATE_RIPOSTE], 'note': "Needs Stable; no Tower Shield or Dual Wield or Ranged Weapon"},
    ...
    "2HBastard":      {"ap": -4, "init":  0, "tier": "Forged",  "tags": [TWO_H, UNWIELDY, UNSTOPPABLE, CLEAVE, NEGATE_SHIELDED]},
    ...
    "Lance":          {"ap": -4, "init":  1, "tier": "Forged",  "tags": [STEADY, UNWIELDY, UNSTOPPABLE, NEGATE_RIPOSTE], 'note': "Needs Stable; no Tower Shield or Dual Wield"},
    "Estoc":          {"ap": -3, "init":  1, "tier": "Crafted", "tags": [STEADY, SHATTER_ARMOR, NEGATE_RIPOSTE, NEGATE_TEMPERED]},
    "Poleaxe":        {"ap": -5, "init":  0, "tier": "Crafted", "tags": [TWO_H, STEADY, SHATTER_ARMOR, UNSTOPPABLE, NEGATE_SHIELDED]},
}
...
ARMORS = {
    "Cloth":       {"save":  8, "tier": "Crude",   "tags": []},
    "Gambeson":    {"save":  7, "tier": "Crude",   "tags": []},
    "Leather":     {"save":  6, "tier": "Cast",    "tags": []},
    "Chainmail":   {"save":  5, "tier": "Wrought", "tags": []},
    "Full Plate":  {"save":  4, "tier": "Forged",  "tags": []},
    "Gothic Plate":{"save":  3, "tier": "Crafted", "tags": []},
}
...
NODES = {
    ...
    "Hospitaller": {
        ...
        "monument": False,
        "escalation": {"standing": "Established Piety", "ranks": {1: f"Recover 8+; {ENDURING}"}, "requires_all": ["Infirmary"], "requires_any": [], "extra_req": ""},
        "engine": {"cost": 1, "prereqs": ["Apothecary", "Infirmary"], "domain": {"Piety": 6}, "innate_tags": ["Recover 5"], "mastery_tags": [ENDURING], "mastery_req": ["Apothecary", "Infirmary"]}},
    "Jester's Court": {
        "type": "Civic",
        "unlock": "1 Rising",
    ...
    "Apothecary": {
        ...
        "innate": "+300",
        "mastery": "Gain Recover 8, or improve Recover by +1.",
        "efficient": "Alchemy",
        ...
        "engine": {"cost": 1, "prereqs": [], "domain": {}, "innate_tags": [], "mastery_tags": ["Recover 7"], "mastery_req": ["Herb Garden"]}},
    "Infirmary": {
        "type": "Civic",
        "unlock": "Rising Piety",
        ...
        "monument": False,
        "escalation": {"standing": "Untested Piety", "ranks": {1: "Recover 9"}, "requires_all": ["Apothecary"], "requires_any": [], "extra_req": ""},
    ...
    "Ministry of Military Strategy": {
        ...
        "mastery": "Deadly, & Cleave also trigger Focused Strikes on a natural 6.",
        ...
        "engine": {"cost": 1, "prereqs": [], "domain": {"Prowess": 10}, "innate_tags": ["Seize: first", "+1I", "MaxInit3"], "mastery_tags": ["Crit 6"], "mastery_req": ["University", "War College"]}},
    "Thieves' Guild": {
        "type": "Monument",
...
BANDIT_FACES = FACES   # die bandits roll for tactics; set to 8 for d8, 10 for d10, etc.
BANDIT_BEHAVIOR = {
    ...
    "Cunning Roll":  "If 10+ retinues in camp, roll a d8 each turn: 1-2 = Intercept Caravan, 3-5 = Raze, 6-7 = Destabilize, 8 = Foster Rebellion.",
    ...
    "Attacking":     f"Move to end adjacent to a camp; another player rolls bandit tactics on a D{BANDIT_FACES} (see the bandit tactic table) and resolves to-strike/save as a Battle. Bandits never Fall Back but may Flee. Extort the camp's gold if destroyed.",
}
...
# ==============================================================================
# Display-name layer — rename what PLAYERS see WITHOUT touching combat.
# ==============================================================================
# The dict KEYS in WEAPONS / RANGED / SHIELDS / ARMORS / NODES are permanent
# ENGINE IDs: combat, pool building, prereqs (mastery_req / builds_into / requires),
# and _POOL_MONUMENTS all key off them. Never rename a key. To rename the shown
# name, add   "engine id": "shown name"   here — combat is unaffected because it
# never reads this map. Cards / compendium / wiki and the loadout name bracket
# resolve names through display(). (Same idea as the keyword constants and
# TAG_DISPLAY already used for tags.)
NAME_DISPLAY = {
    "Spears": "Spear",
    "Pilum": "Angon",
