...
if exist "settlement_mats.py"       %PY% settlement_mats.py "%CE_ROOT%\%OUT_DIR%\settlement_mats.pdf"
echo   Settlement board emulator (HTML)...
if exist "gen_settlement_board.py" %PY% gen_settlement_board.py --data "%DATA_SRC%" --out "settlement_board.html"
echo   Host sheet...
