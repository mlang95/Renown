...
RETINUES = {
    "Levy":           {"cost": 1000, "to_hit": 6, "endurance": 3, "shaking": 7, "unbreakable": False, "speed": 3, "max_size": ARMY_MAX_RETINUES},
    "Man-at-Arms":    {"cost": 2000, "to_hit": 5, "endurance": 4, "shaking": 6, "unbreakable": False, "speed": 2, "max_size": ARMY_MAX_RETINUES},
    "Sergeant":       {"cost": 2500, "to_hit": 3, "endurance": 3, "shaking": 5, "unbreakable": False, "speed": 2, "max_size": ARMY_MAX_RETINUES},
    "Knight Templar": {"cost": 3000, "to_hit": 4, "endurance": 3, "shaking": 4, "unbreakable": False, "speed": 2, "max_size": ARMY_MAX_RETINUES},
}
...
WEAPONS = {
    ...
    "Arming Sword":   {"ap": -2, "init":  0, "tier": "Wrought", "tags": [STEADY]},
    "Pike":           {"ap": -3, "init":  1, "tier": "Wrought", "tags": [TWO_H, STEADY, UNWIELDY, SHATTER_ARMOR]},
    ...
    "Battle Axe":     {"ap": -3, "init": -1, "tier": "Wrought", "tags": [TWO_H, UNWIELDY, CLEAVE, NEGATE_SHIELDED]},
    "Cavalry Spear":  {"ap": -3, "init":  0, "tier": "Wrought", "tags": [STEADY, UNWIELDY, NEGATE_RIPOSTE], 'note': "Needs Stable; no Tower Shield or Dual Wield or Ranged Weapon"},
    "Morningstar":    {"ap": -3, "init": -1, "tier": "Forged",  "tags": [UNWIELDY, CLEAVE, DESTROY_SHIELD], 'note': 'Cannot Dual Wield'},
    "Bastard Sword":  {"ap": -3, "init":  0, "tier": "Forged",  "tags": [STEADY, SHATTER_ARMOR], 'note': 'At the beginning of each equipment step, you may choose the 1H or 2H profile. Cannot Dual Wield'},
    "2HBastard":      {"ap": -4, "init":  0, "tier": "Forged",  "tags": [TWO_H, UNWIELDY, CLEAVE]},
    ...
    "Lance":          {"ap": -6, "init":  1, "tier": "Forged",  "tags": [STEADY, UNWIELDY, SHATTER_ARMOR, UNSTOPPABLE, NEGATE_SHIELDED, NEGATE_RIPOSTE], 'note': "Needs Stable; no Tower Shield or Dual Wield"},
    "Estoc":          {"ap": -4, "init":  1, "tier": "Crafted", "tags": [STEADY, SHATTER_ARMOR, NEGATE_RIPOSTE, NEGATE_TEMPERED]},
    "Poleaxe":        {"ap": -5, "init":  1, "tier": "Crafted", "tags": [TWO_H, STEADY, UNSTOPPABLE, NEGATE_SHIELDED, NEGATE_TEMPERED]},
}
...
RANGED = {
    ...
    "Arquebus":    {"ap": -5, "init":  2, "tier": "Crafted", "tags": [TWO_H, STEADY, UNSTOPPABLE, NEGATE_SHIELDED, NEGATE_RIPOSTE, NEGATE_TEMPERED], 'note': "Requires Advanced Blast Furnace and Artillery Park. May only use the Fighting Formation, Defensive Formation, or Fall Back Tactics.", 'requires': ["ABF", "Artillery Park"], 'tactics_allowed': ["Fighting Formation", "Defensive Formation", "Fall Back"]},
...
SHIELDS = {
    ...
    "Targe Shield":  {"save_bonus": 1, "init": -1, "tier": "Cast",   "tags": [STEADY, MINUS_1_TBH]},
    "Kite Shield":   {"save_bonus": 2, "init": -1, "tier": "Wrought","tags": [UNWIELDY, MINUS_1_TBH]},
    "Tower Shield":  {"save_bonus": 3, "init": -1, "tier": "Forged", "tags": [UNWIELDY, MINUS_1_TBH]},
...
NODES = {
    ...
    "Apothecary": {
        ...
        "monument": False,
        "escalation": {"standing": "Untested Piety", "ranks": {1: "Recover 10"}, "requires_all": [], "requires_any": [], "extra_req": ""},
